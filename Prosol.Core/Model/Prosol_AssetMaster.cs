...
{
    public class Prosol_AssetMaster
    {
        ...
        public Prosol_AssetCondition AssetCondition { get; set; }
        public Prosol_AssetGIS GIS { get; set; }
    ...
    public class Prosol_AssetCondition
    {   
