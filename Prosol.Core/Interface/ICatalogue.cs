   ...
   public interface ICatalogue
    {
       ...
       // string WriteReleaseDataList(List<Prosol_Datamaster> catList);
        string WriteReleaseDataList(List<Prosol_Datamaster> catList, DataTable tbl);
      ...
      //  IEnumerable<Prosol_UOM> getuomlist();
        ...
        //reject
        bool GetCodeForRejectedItems(Prosol_Datamaster cat, string userid, string username, DataTable tbl);
        ...
        Tuple<int, string> BulkShortLong(HttpPostedFileBase file);
        //PVDATA
        ...
        IEnumerable<Prosol_Datamaster> GetDataListpv(int pageNumber, int pageSize, string uId);
        IEnumerable<Prosol_HSNModel> getHSNList(string sKey);
        IEnumerable<Prosol_UNSPSC> getCOMMCOMMList(string sKey);
        bool insertImages(Prosol_Datamaster imgAsset);
        Tuple<int, string> BulkUrl(HttpPostedFileBase file);
        int BulkSingleAttribute(HttpPostedFileBase file);
        int BulkNM(HttpPostedFileBase file);
    }
}
